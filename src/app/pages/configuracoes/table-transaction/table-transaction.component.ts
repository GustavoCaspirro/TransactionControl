...
export class TableTransactionComponent implements OnInit, OnChanges {
  ...
  editaItemData(item: NewTransaction, indexItem: number): void {
    console.log(`item: ${item} de index : ${indexItem}`);
    this.editarItem.emit({ item, indexItem });
  }
