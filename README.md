# Aplicação de Transações [![Build Status](https://travis-ci.org/GustavoCaspirro/TransactionControl.svg?branch=master)](https://travis-ci.org/GustavoCaspirro/TransactionControl)
